...
from efsw.accounts import forms


def login(request):
    if request.method == 'GET':
        return shortcuts.render(request, 'accounts/login.html', {'form': forms.LoginForm()})
        ...
        if form.is_valid():
            ...
            return shortcuts.render(request, 'accounts/login.html', {'form': form})
